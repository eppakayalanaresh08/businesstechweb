      ...
      <div className='appcontainer'>
            ...
            <nav className='navcontainer'>
              <ul className='firstnavcontainer'>
                <li className='listitem'>
                  <Link to="/" className='listlink'>Store</Link>
                </li>
                <li className='listitem'>
                  <Link to="/about" className='listlink'>Location</Link>
                </li>
                <li className='listitem'>
                  <Link to="/contact" className='listlink'>Contact us</Link>
                </li>
              </ul>
              ...
              <ul className='secondNav'>
                ...
                <li className='listitem'>
                  <Link to="/about" className='listlink'>Get directions</Link>
                </li>
                <li className='listitem'>
                  <Link to="/contact" className='listlink'>business hours</Link>
                </li>
              </ul>
            </nav>
            <div>
        ...
        <div>
          <ul className='categoryElement'>
            <li className='listitem'>
              <Link to="/" className='listlinkcategory'>Candle making supplies</Link>
            </li>
            <li className='listitem'>
              <Link to="/" className='listlinkcategory'>Melt and Pour Soap Base</Link>
            </li>
            <li className='listitem'>
              <Link to="/" className='listlinkcategory'>Liquid Base</Link>
            </li>
            <li className='listitem'>
              <Link to="/" className='listlinkcategory'>        Ready To Use Base
              </Link>
            </li>
          </ul>
        </div>
